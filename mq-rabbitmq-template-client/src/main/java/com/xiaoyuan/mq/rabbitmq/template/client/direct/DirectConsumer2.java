...
public class DirectConsumer2 {
    ...
    @RabbitListener(bindings = @QueueBinding(value = @Queue(value = DirectParamConstant.QUEUE_NAME_TWO, durable = "true"), exchange = @Exchange(name = DirectParamConstant.EXCHANGE_NAME), key = {"update", "delete"}))
    @RabbitHandler
    public void process(@Payload String hello, @Headers Map<String, Object> headers, Channel channel) throws IOException {
        System.out.println("update , delete  : " + hello);
        /**
