...
public class FanoutConsumer1 {
    ...
    @RabbitListener(bindings = @QueueBinding(value = @Queue(value = FanoutParamConstant.QUEUE_NAME_ONE, durable = "true"), exchange = @Exchange(name = FanoutParamConstant.EXCHANGE_NAME, type = "fanout"), key = "pubsub"))
    @RabbitHandler
